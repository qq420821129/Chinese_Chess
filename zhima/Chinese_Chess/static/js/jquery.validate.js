...
// jQuery.validator.addMethod("nc",function(value,element,params){
// 	vat st = /^\w[a-zA-Z_0-9]*$/
// 	console.log("hello")
// 	return st.test(value)
// },"必须以字母开头,包含数字和_");
// jQuery.validator.addMethod("vuid",function(value,element,params){
// 	vat st = /^[1-9]\d{5}(19:20)\d{2}(0[1-9]|1[0-2])(0[1-9]|[1-3][0-9])\d*3(x|\d)*$/
// 	return st.test(value)
// }),"请输入有效证件号";
...
// }, "请输入有效邮箱");
// jQuery.validator.addMethod("ntel", function(value, element) {   
//     var tel = /^1[0-9]{11}$ /;
//     return (tel.test(value));
// }, "请输入有效手机号");
...
jQuery.validator.addMethod("username",function(value,element){
	var num = /^[a-zA-Z][a-zA-Z0-9_]{5,15}$/i
	return this.optional(element) || num.test(value)
},"请输入有效的用户名");
